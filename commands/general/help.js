...
module.exports = {
  ...
  execute(bot, message, args) {
    ...
    if (!args[0]) {
      ...
      if (!command) return message.channel.send({embed: {title: "Error ⚠️", description:`There's no such a command like that, to see the full command list please use \`${message.prefix}commands\` command.`, color: '#f83e42'}});
